...
ARRAY['pela defesa do equilíbrio orçamentário e da redução dos gastos públicos em períodos de crise.', 'pela valorização do livre mercado como mecanismo exclusivo de autorregulação econômica.', 'pela intervenção do Estado na economia como forma de estimular a produção e o emprego.', 'pela crítica ao capitalismo industrial e pela proposta de sua superação por um modelo socialista.', 'pela ênfase no controle da inflação como principal instrumento de crescimento econômico.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['contribui diretamente para o acesso ao conhecimento verdadeiro das ideias.', 'deve ser valorizada por sua capacidade de representar fielmente a realidade sensível.', 'afasta o indivíduo do conhecimento racional, por se basear na imitação das aparências.', 'exerce função educativa central na formação moral dos cidadãos da pólis.', 'supera a filosofia ao permitir a apreensão imediata da verdade.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['o crescimento urbano implicou a canalização e o ocultamento de cursos d''água originalmente visíveis na paisagem.', 'os rios urbanos mantiveram suas características naturais, mesmo diante da expansão da cidade.', 'a urbanização paulista priorizou a preservação integral das nascentes e margens fluviais.', 'a expansão da cidade ocorreu sem impactos significativos sobre a rede hidrográfica local.', 'os recursos hídricos deixaram de exercer influência sobre a organização do espaço urbano.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['intrusão ígnea', 'solidificação do magma', 'recristalização do magma', 'formação em alta pressão', 'presença de estratificação'],
...
ARRAY['Substantivo concreto, designando um ser biológico.', 'Adjetivo, qualificando o substantivo "organismo" e atribuindo-lhe uma característica dinâmica.', 'Advérbio de modo, indicando como a linguagem se comporta.', 'Particípio verbal com valor passivo.', 'Pronome indefinido, indicando uma generalização.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Fonologia',
'Sobre a palavra labirintos, assinale a alternativa correta quanto à sua fonologia:',
ARRAY['É uma paroxítona que possui um dígrafo vocálico', 'Apresenta nove letras e nove fonemas, sem presença de dígrafos.', 'Contém um hiato e um dígrafo consonantal.', 'Possui dois dígrafos vocálicos ("in" e "on") e um encontro', 'É uma palavra proparoxítona com um ditongo decrescente.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Improvisar (de improviso).', 'Pesquisar (de pesquisa).', 'Civilizar (de civil).', 'Amenisar (de ameno).', 'Paralisar (de paralisia).'],
3, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Duas.', 'Três.', 'Quatro.', 'Cinco.', 'Seis.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Sentido.', 'Escritor.', 'Organismo.', 'Silêncio.', 'Adjetivo.'],
3, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Infelizmente', 'Anoitecer', 'Planalto', 'Passatempo', 'Ilegal'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Verbos',
'No trecho "Se eles mantivessem a calma, talvez enxergassem...", os verbos estão flexionados no:',
ARRAY['Pretérito perfeito do indicativo, indicando ações concluídas.', 'Futuro do pretérito do indicativo, indicando possibilidade futura.', 'Pretérito imperfeito do subjuntivo, indicando uma condição hipotética no passado/presente.', 'Presente do subjuntivo, expressando um desejo atual.', 'Infinitivo pessoal, indicando a intenção dos sujeitos.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Pronome pessoal do caso reto, funcionando como sujeito de "permite".', 'Pronome pessoal oblíquo átono, funcionando como objeto indireto e retomando "Os homens de armas".', 'Pronome possessivo, indicando posse em relação ao "recuo".', 'Pronome demonstrativo, apontando para a "incerteza".', 'Partícula de realce, sem valor sintático.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Rio.', 'Próprio.', 'Paciência.', 'Força.', 'Incerteza.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Pronome reflexivo.', 'Pronome apassivador (A vitória é construída).', 'Índice de indeterminação do sujeito.', 'Conjunção condicional.', 'Parte integrante do verbo "saber".'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Enumerar ações rápidas da personagem.', 'Enfatizar a natureza opressiva e solitária do luto da mãe.', 'Corrigir um erro de concordância nominal.', 'Indicar que a sombra é um personagem físico que entrou no quarto.', 'Separar orações coordenadas sindéticas.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Fonologia',
'A palavra vozearias possui:',
ARRAY['Um ditongo e um hiato.', 'Dois ditongos crescentes.', 'Apenas um encontro consonantal.', 'Três sílabas e dois dígrafos.', 'Um tritongo na última sílaba.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Verbos',
'Em "...a sua cabeça anda em serviço de escutar", o verbo andar está sendo usado com valor:',
ARRAY['De movimento físico/locomoção.', 'Auxiliar, indicando uma ação que se prolonga no tempo (aspecto durativo).', 'De ligação, indicando um estado permanente.', 'Transitivo direto, exigindo complemento de lugar.', 'Impessoal, sem sujeito definido.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Substantivo',
'Assinale a alternativa em que a palavra retirada do texto é um substantivo abstrato:',
ARRAY['Cabeça.', 'Aves.', 'Serviço.', 'Mãe.', 'Noite.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Acentuação',
'Quanto à acentuação, as palavras história e silenciosa diferenciam-se porque:',
ARRAY['Ambas são paroxítonas, mas apenas a primeira termina em ditongo crescente.', 'A primeira é proparoxítona e a segunda é oxítona.', 'A primeira é paroxítona terminada em ditongo acentuada, a segunda é paroxítona terminada em "a" não acentuada.', 'Ambas possuem hiato tônico.', 'A regra de acentuação é a mesma para ambas.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['por que - porquê - Por quê - porque', 'porquê - porque - Por que - por quê', 'por quê - por que - Por que - porquê', 'porquê - por que - Por quê - porque', 'por que - porque - Por que - por quê'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Português', 'Classes de Palavras',
'Assinale a alternativa em que o termo destacado é um advérbio:\n',
ARRAY['"A menina tinha o rosto muito pálido."', '"A mãe sentiu o seu próprio cheiro."', '"Aquela era a única filha."', '"O médico era um homem sério."', '"As flores eram belas."'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Prata / Unha.', 'Sangue / Roxo.', 'Pássaro / Estrela.', 'Blusa / Campo.', 'Carro / Chave.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Contradição.', 'Conclusão.', 'Alternativa.', 'Adição.', 'Causa.'],
3, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Due to.', 'In spite of.', 'Because of.', 'Since.', 'Rather than.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Concessão.', 'Condição negativa (A menos que).', 'Finalidade.', 'Proporção.', 'Certeza absoluta.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),

(gen_random_uuid(), 'Inglês', 'Conectivos',
'No trecho — These projects are expensive; nevertheless, they are essential... — o termo em destaque expressa ideia de:',
ARRAY['Explicação.', 'Soma de ideias.', 'Contraste ou oposição.', 'Tempo decorrido.', 'Comparação de igualdade.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['R$ 260,00.', 'R$ 264,00.', 'R$ 272,00.', 'R$ 276,00.', 'R$ 280,00.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['21 km.', '23 km.', '25 km.', '31 km.', '33 km.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['R$ 80,00.', 'R$ 100,00.', 'R$ 120,00.', 'R$ 140,00.', 'R$ 160,00.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['y = -0,004x² + 0,8x', 'y = -0,01x² + x', 'y = -0,002x² + 0,4x', '250y = 100x - x²', '100 = 40x - x²'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['[1 -0,5; -2 1,5]', '[2 -1; -4 3]', '[1,5 -0,5; -2 1]', '[-3 -1; -4 -2]', '[1 1; 1 1]'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['1,08.', '1,26.', '1,32.', '1,54.', '1,60.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['R$ 145,00.', 'R$ 160,00.', 'R$ 175,00.', 'R$ 180,00.', 'R$ 215,00.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['200 metros', '400 metros', '600 metros', '800 metros', '900 metros'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['40 m e reta vertical.', '80 m e arco de parábola.', '40 m e arco de parábola.', '80 m e reta vertical.', '100 m e arco de parábola.'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['15 m/s.', '20 m/s.', '12 m/s.', '10 m/s.', '22 m/s'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['220.', '1.100', '2.200', '3.300', '4.400'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['640 N e N < P.', '800 N e N = P.', '960 N e N > P.', '960 N e N < P.', '160 N e N = P.'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['333,3 N', '366,7 N', '433,3 N', '500,0 N', '600,0 N'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Rutherford, teoria da lâmina de ouro', 'Thomson, teoria pudim de passas', 'Dalton, maciço, indivisível e indestrutível', 'Bohr, teoria do subnível', 'Chadwick, teoria newtoniana'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Cristalização fracionada.', 'Sublimação direta.', 'Decantação estática.', 'Destilação simples.', 'Filtração comum.'],
4, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['heterogênea, imiscíveis e mais.', 'heterogênea, imiscíveis e menos.', 'heterogênea, miscíveis e mais.', 'homogênea, imiscíveis e mais.', 'homogênea, miscíveis e menos.'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['O elemento X possui maior energia de ionização que o elemento Y.', 'O elemento Y é um excelente condutor de eletricidade e calor em condições ambientes.', 'O elemento Z está localizado em um período acima do elemento X.', 'O elemento W possui um número atômico menor que o elemento Y.', 'A ligação química formada entre X e Y terá caráter predominantemente covalente.'],
3, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Complexo de Golgi', 'Lisossomos', 'Mitocôndrias', 'Retículo Endoplasmático Rugoso', 'Ribossomos'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Citocinese', 'Crossing-over (Permuta)', 'Separação das cromátides irmãs', 'Condensação da cromatina', 'Formação do fuso mitótico'],
1, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Legalidade.', 'Impessoalidade.', 'Moralidade.', 'Publicidade.', 'Eficiência.'],
4, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Windows + L', 'Alt + F4', 'Windows + Tab', 'Ctrl + Shift + Esc', 'Windows + D'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Para (To)', 'Cc (Com Cópia)', 'Assunto (Subject)', 'Cco (Bcc)', 'Anexo (Attachment)'],
3, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['=SE(A1>=7;"APROVADO";"REPROVADO")', '=SE(A1<7;"APROVADO";"REPROVADO")', '=SOMA(A1>=7;"APROVADO")', '=PROCV(A1;7;"APROVADO")', '=CONDICIONAL(A1>=7;"APROVADO")'],
0, 'Legado Militar', '2026', 'Médio', 'VUNESP'),
...
ARRAY['Spyware.', 'Phishing.', 'Ransomware.', 'Adware.', 'Trojan (Cavalo de Troia).'],
2, 'Legado Militar', '2026', 'Médio', 'VUNESP');
